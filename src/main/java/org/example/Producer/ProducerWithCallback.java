...
/*
 ...
 Confirm the Partition and Offset of the message was sent using Callbacks
 We'll Look into the behavior of StickyPartitioner
 */
...
public class ProducerWithCallback {
    ...
    private static final Logger  LOGGER = LoggerFactory.getLogger(ProducerWithCallback.class.getName());
